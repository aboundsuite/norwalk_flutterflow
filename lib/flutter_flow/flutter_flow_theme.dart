...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF06264C);
  late Color secondary = const Color(0xFFB0D946);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFFFF8C00);
  ...
  late Color accent1 = const Color(0xFF1E90FF);
  late Color accent2 = const Color(0xFFFF1493);
  late Color accent3 = const Color(0xFF32CD32);
  ...
  late Color primaryBtnText = const Color(0xFF1D1D1A);
  late Color lineColor = const Color(0xFFE0E3E7);
  late Color navBarBG = const Color(0xFF06264C);
  late Color navBarUnselected = const Color(0xFF0B4A97);
  late Color customColor1 = const Color(0xFFB0D946);
}
