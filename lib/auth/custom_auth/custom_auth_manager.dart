...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    norwalkBaptistChurchAuthUserSubject.add(
      NorwalkBaptistChurchAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<NorwalkBaptistChurchAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  NorwalkBaptistChurchAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = NorwalkBaptistChurchAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    norwalkBaptistChurchAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
NorwalkBaptistChurchAuthUser? currentUser;
