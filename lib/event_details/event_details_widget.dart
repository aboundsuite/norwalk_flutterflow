  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final eventDetailsGetEventByIDResponse = snapshot.data!;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          GetEventByIDCall.eventTItle(
                                            eventDetailsGetEventByIDResponse
                                                .jsonBody,
                                          ),
                                          'eventTitle',
                                        ),
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          GetEventByIDCall.eventDescription(
                                            eventDetailsGetEventByIDResponse
                                                .jsonBody,
                                          ),
                                          'description',
