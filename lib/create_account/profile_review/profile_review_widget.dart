...
export 'profile_review_model.dart';

class ProfileReviewWidget extends StatefulWidget {
  const ProfileReviewWidget({super.key});

  @override
  State<ProfileReviewWidget> createState() => _ProfileReviewWidgetState();
}

class _ProfileReviewWidgetState extends State<ProfileReviewWidget>
    with TickerProviderStateMixin {
  late ProfileReviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileReviewModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final profileReviewAuthMeChurchResponse = snapshot.data!;
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        if (AuthMeChurchCall.submittedForApproval(
                              profileReviewAuthMeChurchResponse.jsonBody,
                            ) ==
                            false)
                          Text(
                            'Complete your  profile for administrator\n approval!',
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          if (confirmDialogResponse) {
                            ...
                            context.goNamedAuth('public2', context.mounted);
                          } else {
                                            ...
                                            child: FlutterFlowExpandedImageView(
                                              image: Image.network(
                                                AuthMeChurchCall.userCoverPhoto(
                                                  profileReviewAuthMeChurchResponse
                                                      .jsonBody,
                                                )!,
                                                fit: BoxFit.contain,
                                              ),
                                                        ...
                                                        if (confirmDialogResponse) {
                                                          ...
                                                          if ((_model.submited
                                                            ...
                                                            ScaffoldMessenger
                                                              ...
                                                              SnackBar(
                                                                content: Text(
                                                                  'You have successfully submitted for approval.  You will be notified.',
                                                                  style:
                                                                      TextStyle(
                                                                    color: FlutterFlowTheme.of(
                                                                            context)
