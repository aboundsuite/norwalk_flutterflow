...
class AccountCreate2Widget extends StatefulWidget {
  const AccountCreate2Widget({super.key});

  @override
  State<AccountCreate2Widget> createState() => _AccountCreate2WidgetState();
}

class _AccountCreate2WidgetState extends State<AccountCreate2Widget> {
  late AccountCreate2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountCreate2Model());
  }
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed('AccountCreate3');
                            },
                            text: 'I am ready to create my profile',
