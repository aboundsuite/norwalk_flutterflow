...
class _MyFamilyWidgetState extends State<MyFamilyWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyFamilyModel());
