  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final groupDetailsGetGroupIDResponse = snapshot.data!;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          GetGroupIDCall.groupName(
                                            groupDetailsGetGroupIDResponse
                                                .jsonBody,
                                          ),
                                          'eventTitle',
                                        ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              GetGroupIDCall.groupMeetingDay(
                                                groupDetailsGetGroupIDResponse
                                                    .jsonBody,
                                              ),
                                              'meetingDay',
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              GetGroupIDCall.groupMeetingTime(
                                                groupDetailsGetGroupIDResponse
                                                    .jsonBody,
                                              ),
                                              'meetingtime',
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          GetGroupIDCall.groupDescription(
                                            groupDetailsGetGroupIDResponse
                                                .jsonBody,
                                          ),
                                          'description',
