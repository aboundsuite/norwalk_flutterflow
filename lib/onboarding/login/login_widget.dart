  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final loginGetChurchInformationResponse = snapshot.data!;
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        GetChurchInformationCall
                                            .profilePhotoURL(
                                          loginGetChurchInformationResponse
                                              .jsonBody,
                                        )!,
                                        width: 200.0,
                                        height: 200.0,
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if ((_model.login?.succeeded ??
                                            ...
                                            if (MemberLoginApprovalCall
                                                .userChurchRelationship(
                                              (_model.login?.jsonBody ?? ''),
                                            )!) {
