                                    ...
                                    child: Padding(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(12.0),
                                        child: Image.asset(
                                          'assets/images/Pastor_Photo.png',
                                          width: double.infinity,
                                          height: 300.0,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(12.0),
                                        child: Image.asset(
                                          'assets/images/Genesis_Kids_1.png',
                                          width: double.infinity,
                                          height: 300.0,
                                          fit: BoxFit.cover,
                                        ),
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            await launchUrl(Uri(
                                                scheme: 'mailto',
                                                path: 'info@norwalkbc.com',
                                                query: {
                                                  'subject':
                                                      'Email from Norwalk Baptist Church App',
                                                }
                                                    .entries
                                                    .map((MapEntry<String,
                                                                String>
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            await launchURL(
                                                'https://www.youtube.com/@norwalkbaptistchurch1635');
                                          },
                                          child: FaIcon(
